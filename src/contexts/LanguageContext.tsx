...
const translations = {
  en: {
    ...
    yieldsDesc: 'Generate 3–15% APY on stablecoins via secure, audited DeFi protocols. Withdraw anytime.',
    yieldsApy: '3–15% APY',
  ...
  es: {
    ...
    yieldsDesc: 'Genera 3–15% APY en stablecoins vía protocolos DeFi auditados y seguros. Retira cuando quieras.',
    yieldsApy: '3–15% APY',
