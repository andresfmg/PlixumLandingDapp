...
const translations = {
  en: {
    ...
    // Comparison table
    cmpLabel: 'How we compare',
    cmpTitle: 'Built for what traditional banks can\'t do',
    cmpColTrad: 'Traditional Bank',
    cmpColPlixum: 'Plixum',
    cmpFeature1: 'Global virtual accounts',
    cmpTrad1: 'Not available',
    cmpPlx1: '44+ countries · IBAN & ACH',
    cmpFeature2: 'International settlement',
    cmpTrad2: 'T+3 to T+5 · $25–45 fee',
    cmpPlx2: 'Same day · transparent fee',
    cmpFeature3: 'Multi-currency support',
    cmpTrad3: 'Local currency only',
    cmpPlx3: 'USD, EUR, BRL, USDC, EURC',
    cmpFeature4: 'API integration',
    cmpTrad4: 'Manual process',
    cmpPlx4: 'REST API + webhooks',
    cmpFeature5: 'Business onboarding',
    cmpTrad5: 'Weeks, in-branch',
    cmpPlx5: 'Digital, within days',
    cmpFeature6: 'Treasury automation',
    cmpTrad6: 'Manual / spreadsheets',
    cmpPlx6: 'Programmable rules',
  ...
  es: {
    ...
    cmpLabel: 'Cómo nos comparamos',
    cmpTitle: 'Construido para lo que la banca tradicional no puede hacer',
    cmpColTrad: 'Banco Tradicional',
    cmpColPlixum: 'Plixum',
    cmpFeature1: 'Cuentas virtuales globales',
    cmpTrad1: 'No disponible',
    cmpPlx1: '44+ países · IBAN y ACH',
    cmpFeature2: 'Settlement internacional',
    cmpTrad2: 'T+3 a T+5 · $25–45 USD',
    cmpPlx2: 'Mismo día · fee transparente',
    cmpFeature3: 'Soporte multi-moneda',
    cmpTrad3: 'Solo moneda local',
    cmpPlx3: 'USD, EUR, BRL, USDC, EURC',
    cmpFeature4: 'Integración API',
    cmpTrad4: 'Proceso manual',
    cmpPlx4: 'REST API + webhooks',
    cmpFeature5: 'Onboarding empresarial',
    cmpTrad5: 'Semanas, en sucursal',
    cmpPlx5: 'Digital, en días',
    cmpFeature6: 'Automatización de tesorería',
    cmpTrad6: 'Manual / hojas de cálculo',
    cmpPlx6: 'Reglas programables',
